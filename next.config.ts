...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/rekey", destination: "/services/rekeying", permanent: true },
      { source: "/rekeying", destination: "/services/rekeying", permanent: true },
      ...
      { source: "/lock-rekeying-:city", destination: "/services/rekeying", permanent: true },
