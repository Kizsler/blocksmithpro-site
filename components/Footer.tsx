...
import { CONTACT, SOCIAL, NAV_LINKS, SERVICES } from "@/lib/site-data";
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex h-8 w-8 items-center justify-center border border-gray-600 hover:border-brand-red hover:text-brand-red transition-colors"
              >
